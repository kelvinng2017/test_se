...
SV_CarrierLoc=56 # A
SV_CarrierState=604 # U2: wait_in=1, transfer=2, wait_out=3, completed=4, alternate=5,installed=6
...
class E88MirleEquipment(secsgem.GemEquipmentHandler):
    def __init__(self, address, port, active, session_id, name='Gyro Agvc', log_name="E88_hsms_communication", mdln='STKC_v1.1', T3=45, T5=10, T6=5, T7=10, T8=5, custom_connection_handler=None, initial_control_state="ONLINE", initial_online_control_state="REMOTE"):
        ...
        self.remote_commands.update({
            ...
            "SCAN": secsgem.RemoteCommand("SCAN", "scan command", ["CARRIERLOC"], None, ["CARRIERID"]),
    ...
    def _on_rcmd_SCAN(self, CARRIERLOC, system, ack_params, CARRIERID=None):
        print("\nget scan cmd, param:{}".format([CARRIERLOC, CARRIERID]))
        print("get scan cmd, system:{}, ack_parmas:{}\n".format(system, ack_params))
        ...
        if CARRIERID and CARRIERID not in self.Carriers.Data:
            ...
            if CARRIERID:
                self.carrier_id_read(CARRIERID, CARRIERLOC, 0)
            else:
