...
if __name__ == '__main__':
    ...
    parser.add_argument('-e88_variant', default='standard', help='choose E88 equipment variant')
    ...
    global_variables.e88_variant=args.e88_variant
    print('-e88_variant', args.e88_variant)
    ...
    if 'v3' in global_variables.api_spec: #E82&E88
        ...
        eq_cls = E88.E88Equipment if global_variables.e88_variant == 'standard2' else E88Mirle.E88MirleEquipment
